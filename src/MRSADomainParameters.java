...
public class MRSADomainParameters implements Serializable {
 
	public static MRSADomainParameters NIST_B_163() 
	{
		F2m.setModulus(163, 7, 6, 3, 0);
		MRSADomainParameters NIST_B_163 =
	 ...
	 * Constructor
	 */
	public MRSADomainParameters() {
	}

	/**
	 * Constructor
	 */
	public MRSADomainParameters(MRSADomainParameters dp) {
		this.m = dp.m;
		this.basis = dp.basis;
	...
	protected Object clone() {
		return new MRSADomainParameters(this);
	}
}
